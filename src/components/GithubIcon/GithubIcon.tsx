...
const OFFICIAL_PATH =
  ...
  "0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.955-.266 1.98-.399 3-.405 " +
  "1.02.006 2.045.139 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 " +
  "0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57 " +
  "C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12";

export function GithubIcon({ size = 20, className, title }: GithubIconProps): ReactElement {
  return (
    <svg
      width={size}
      height={size}
