...
interface LogoProps {
  /** Show the "Undertow" wordmark next to the mark. Defaults to true. */
...
/**
 * The Undertow mark: a single-line spiral (an undertow / vortex sigil)
 * paired with the italic serif wordmark. See /brand for full guidelines.
 */
