...
export const ICON_PATHS: Record<IconName, string> = {
  ...
  "github": `<path d="M12 3.5c-4.7 0-8.5 3.9-8.5 8.7 0 3.9 2.5 7.1 5.9 8.3.4.1.6-.2.6-.4v-1.6c-2.4.5-2.9-1.2-2.9-1.2-.4-1-1-1.3-1-1.3-.8-.6.1-.6.1-.6.9.1 1.4.9 1.4.9.8 1.4 2.1 1 2.6.8.1-.6.3-1 .6-1.3-1.9-.2-3.9-1-3.9-4.4 0-1 .3-1.7.9-2.4-.1-.2-.4-1.1.1-2.4 0 0 .8-.3 2.5.9a8.4 8.4 0 0 1 4.6 0c1.7-1.2 2.5-.9 2.5-.9.5 1.3.2 2.2.1 2.4.6.7.9 1.5.9 2.4 0 3.4-2 4.2-3.9 4.4.3.3.6.8.6 1.7v2.5c0 .2.2.5.6.4 3.4-1.2 5.9-4.4 5.9-8.3 0-4.8-3.8-8.7-8.5-8.7z"/>`,
